...
const sectionText = {
  ...
  skillsInDevelopment: [{
    ...
    text: [
      ...
      "Webpack (for example project with prefixer, babel).",
    ...
    ]},
  {
    ...
    text: [
      ...
      "Webpack (например сборка кроссбраузерного проекта с prefixer, babel).\nНачальный Node.js (например использование eslint-air-bnb).",
    ]}],
  portfolio: [{
    title: "My works",
    text: ""
  ...
  education: [{
    title: "Education",
    text: ["RS School «JavaScript/Front-end» 25 weeks course. During the course were developed many apps, including two team developments. In the final team-project I was a team-lead (2020).",
    "",
  ...
  {
    title: "Образование",
    text: ["RS School «JavaScript/Фронт-энд» 25-ти недельный курс. На курсе было сделано множество приложений, два из которых были командными. В финальном командном проекте я был в качестве тим-лида (2020).",
    "",
  ...
  workExperience: [{
    ...
    text: ["“Azotremstroy” 2018 – 2020, Tolyatti, Russia, Engineer. Fire system design. Work with documents, projects.",
    "",
  ...
  {
    title: "Опыт работы",
    text: ["“Азотремстрой” 2018 – 2020, г. Тольятти, Россия, инженер. Разработка пожарных систем. Работа с документацией. Проектирование.",
    "",
      ...
      <section class="section">
        ...
        <article class="article">
          ...
          <div class="article__text">
            ...
            <p class="article__paragraph">{this.findText("skillsInDevelopment").text[15]}</p>
            <p class="article__paragraph">{this.findText("skillsInDevelopment").text[16]}</p>
          </div>
        </article>
